...
Revision ID: b75548cce765
Revises: 
Create Date: 2024-06-19 00:06:27.587723
...
def upgrade() -> None:
    ...
    op.create_table('centros_trainamento',
    sa.Column('pk_id', sa.Integer(), nullable=False),
    sa.Column('nome', sa.String(length=50), nullable=False),
    ...
    sa.ForeignKeyConstraint(['centro_treinamento_id'], ['centros_trainamento.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
...
def downgrade() -> None:
    ...
    op.drop_table('centros_trainamento')
